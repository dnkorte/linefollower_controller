...
print("before calibration:", value[0], value[1], value[2], value[3], value[4], value[5], value[6])

write_only(0x32, 0x01)	# initiate calibration
for i in range(12):
	value = read_7(0x32)
	print("checking:",value[0], value[1], value[2], value[3], value[4], value[5], value[6])
	time.sleep(1)
...
for i in range(80):
	...
	time.sleep(0.006)
	value = read_7(0x32)
	print("psn check:",value[0], value[1], value[2], value[3], value[4], value[5], value[6])
	time.sleep(0.25)
